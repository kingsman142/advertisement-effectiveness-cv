...
with open('useful-videos-effectiveness-ratings.txt', 'r') as useful_videos:
    bottom_400 = list(reversed([x for x in itertools.islice(useful_videos, None)][-(1):-(400+1):-1]))
for i in range(0, 400):
    bottom_400[i] = bottom_400[i].split("www.youtube.com/watch?v=")[1].split(" ")[0] # Grab the video ID for all 400 videos
    topic = topics_data_stats[bottom_400[i]]
    sentiment = sentiments_data_stats[bottom_400[i]]
...
plt.ylabel("Topics")
plt.xlabel("Counts")
plt.title("Topics Distribution of 400 Least Effective Ads")
plt.savefig("bottom_400_topics_distribution_bar.png")

plt.figure()
plt.barh(zero_to_thirty, sentiments_height, align='center', tick_label=sentiments_labels)
plt.ylabel("Sentiments")
plt.xlabel("Counts")
plt.title("Sentiments Distribution of 400 Least Effective Ads")
plt.savefig("bottom_400_sentiments_distribution_bar.png")
...
plt.savefig("bottom_400_topics_distribution_pie.png")
...
plt.savefig("bottom_400_sentiments_distribution_pie.png")
...
plt.figure()
plt.title("Normalized Topics Distribution, Bottom 400 Most Effective Ads")
plt.barh(zero_to_thirtyeight, topics_pie_normalized, align='center', tick_label=topics_labels_copy)
plt.tight_layout()
plt.savefig("bottom_400_topics_distribution_normalized.png")
...
plt.figure()
plt.title("Normalized Sentiments Distribution, Bottom 400 Most Effective Ads")
plt.barh(zero_to_thirty, sentiments_pie_normalized, align='center', tick_label=sentiments_labels_copy)
plt.tight_layout()
plt.savefig("bottom_400_sentiments_distribution_normalized.png")
